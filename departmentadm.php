<?php
//*****************************************************************************
// $Header: /srv/cvsroot/AQasset/admin/departmentadm.php,v 1.2 2005/04/14 14:04:08 druus Exp $
//
// $Author: druus $
//
...
// History
// -------
// $Log: departmentadm.php,v $
// Revision 1.2  2005/04/14 14:04:08  druus
...
<HTML>
<HEAD>
<TITLE>OSCAR Department Admin</TITLE>
...
if ($values['cmd'] == "" || $values['cmd'] == "listall")
{
	...
	*/
		$selectUsers = "SELECT * FROM departments ORDER BY dep_name";
?>
...
<TR>
	<TD COLSPAN="3">
	<A HREF="<?php echo $_SERVER['PHP_SELF']?>?cmd=newdep">Create a new department</A>
	</TD>
</TR>
<TR BGCOLOR="6780B8">
...
<?php
		while ($listuser = mysql_fetch_array($userResult))
			print "<TR>\n\t<TD><A HREF=\"" . $PHP_SELF . "?cmd=edit&dep_id=" . $listuser['dep_id'] . "\">" . $listuser['dep_name'] . "</A></TD><TD>" . $listuser['active'] . "</TD></TR>\n";
	}
?>
<TR>
	<TD COLSPAN="3">
...
# Edit an asset
if ($values['cmd'] == "edit" || $values['cmd'] == "newdep")
{
	...
	if ($values['cmd'] == "edit")
	{
		...
		$query = "SELECT * FROM departments WHERE dep_id = " . $values['dep_id'] . " LIMIT 1";
		...
		else
		{
			...
			#
			print "<H3 ALIGN=\"center\">Edit Departments</H3>\n";
		...
		print "<H3 ALIGN=\"center\">Create New AQ Department</H3>\n";
?>
<FORM ACTION="<?php echo $PHP_SELF;?>" METHOD="post">
<?php
if ($values['cmd'] == "edit")
{
	print "<INPUT TYPE=\"hidden\" NAME=\"cmd\" VALUE=\"updatedep\">\n";
	print "<INPUT TYPE=\"hidden\" NAME=\"dep_id\" VALUE=\"" . $statusDetails['dep_id'] . "\">\n";
}
else
	print "<INPUT TYPE=\"hidden\" NAME=\"cmd\" VALUE=\"create_new_dep\">\n";
?>

<TABLE BORDER="0" ALIGN="center">
<TR BGCOLOR="6780B8">
	<TD COLSPAN="4"><FONT COLOR="white">Department details</FONT></TD>
</TR>
<TR>
	<TD>Department</TD>
	<TD><INPUT TYPE="text" NAME="dep_name" CLASS="input-style" VALUE="<?php echo $statusDetails['dep_name'] ?>" onFocus="style.backgroundColor='#FFFFCC'" onBlur="style.backgroundColor='#FFFFFF'"></TD>
	<TD></TD>
	<TD></TD>
</TR>
<TR>
...
?>
	<TD COLSPAN="4">
		...
		<A HREF="<?php echo $_SERVER['PHP_SELF'];?>?cmd=delete_dep&dep_id=<?php echo $statusDetails['dep_id'];?>" onClick="return confirmSubmit('Are you sure you want to delete this AQ Department?');">
		<IMG SRC="images/delete_small.gif" BORDER="0" ALT="Delete Department">Delete Department
		</A>&nbsp;&nbsp;
	</TD>
<?php
}
...
if ($values['cmd'] == "create_new_dep")
{
	// Create an INSERT statement for a new Status level
	$createNew = "INSERT INTO departments ";
	$createNew .= "(dep_name, active) ";
	$createNew .= "VALUES ('" . $values['dep_name'] . "', ";
...
if ($values['cmd'] == "updatedep")
{

	$query = "UPDATE departments ";
	$query .= "SET dep_name = '" . $values['dep_name'] . "', ";
