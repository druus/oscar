...
//CloseTable();
print "<BR><BR><BR><ADDRESS>&copy;&nbsp;Absolute Quality 2004 - Contact <A HREF=\"mailto:druus@AbsoluteQuality.co.uk\">webmaster</A> for comments and suggestions.<BR>\$Revision: 1.2 $</ADDRESS>\n";
//include("footer.php");
